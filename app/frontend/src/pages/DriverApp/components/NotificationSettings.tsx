        ...
        <div className="flex-1 overflow-auto p-4">
          {loading ? (
            ...
            <div className="space-y-6">
                ...
                <div className="bg-slate-800 rounded-xl overflow-hidden">
                  {Object.entries(settings.push_notifications).map(([key, value], i, arr) => (
                    <button key={key} onClick={() => handleToggle('push_notifications', key)}
                      className={`w-full flex items-center justify-between p-3 ${i < arr.length - 1 ? 'border-b border-slate-700' : ''}`}>
                      <span className="text-slate-300 text-sm">{settingLabels[key]}</span>
              ...
              <div>
                <div className="flex items-center gap-2 mb-3">
                  <Volume2 className="text-orange-400" size={16} />
                  <h3 className="text-white font-semibold">In-App Sounds</h3>
                </div>
                <div className="bg-slate-800 rounded-xl overflow-hidden">
