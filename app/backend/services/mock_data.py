...
faq_data = [
    ...
    {"id": 10, "category": "Features", "question": "How does SnapRoad score my driving?", "answer": "Your safety score reflects smooth driving, speed habits, and trip completion. Check Profile and Insights for trends and tips."},
