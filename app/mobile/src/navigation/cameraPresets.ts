...
export function getCameraPreset({
  ...
  const openRoadPitchBoost =
    mode === 'calm' ? 1.85 * longRoad01 : mode === 'adaptive' ? 2.4 * longRoad01 : 3.1 * longRoad01;
  ...
  let paddingTop =
    ...
    speedTopBoost +
    longRoad01 * (mode === 'calm' ? 24 : mode === 'adaptive' ? 38 : 50);
  ...
  paddingBottom -= (mode === 'calm' ? 10 : mode === 'adaptive' ? 16 : 24) * longRoad01;
