            ...
            {activeTripSummary.counted === false && (
              <View style={{ backgroundColor: isLight ? 'rgba(245,158,11,0.12)' : 'rgba(245,158,11,0.15)', borderRadius: 12, padding: 12, marginBottom: 12 }}>
                <Text style={{ color: isLight ? '#92400E' : '#FBBF24', fontSize: 13, fontWeight: '600', textAlign: 'center' }}>
                  This drive didn’t meet the minimum to count for trip history. You need at least 30 seconds of driving and
                  about 0.1 miles of real GPS movement. Try a slightly longer trip next time.
                </Text>
              </View>
            )}
            {activeTripSummary.counted !== false && activeTripSummary.reward_eligible === false && (
              <View style={{ backgroundColor: isLight ? 'rgba(59,130,246,0.10)' : 'rgba(59,130,246,0.16)', borderRadius: 12, padding: 12, marginBottom: 12 }}>
                <Text style={{ color: isLight ? '#1D4ED8' : '#93C5FD', fontSize: 13, fontWeight: '600', textAlign: 'center' }}>
                  This trip was logged for Insights. Trips need about 1 mile to earn gems.
                </Text>
              </View>
            )}
