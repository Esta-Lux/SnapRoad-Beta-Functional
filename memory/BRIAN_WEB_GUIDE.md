...
```bash
# Test boost pricing
curl https://cleanup-check.preview.emergentagent.com/api/partner/boosts/pricing

# Test trip analytics
curl "https://cleanup-check.preview.emergentagent.com/api/trips/history/detailed?days=30"

# Test route history
curl "https://cleanup-check.preview.emergentagent.com/api/routes/history-3d?days=90"
```
